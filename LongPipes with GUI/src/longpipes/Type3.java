...
public class Type3 extends Pipe {
    ...
    public Type3(double length, double d, int plasticGrade, int colorPrint, boolean innerInsulation, boolean outerInsulation, boolean chemRes) {
        this.length = length;
        this.d = d;
