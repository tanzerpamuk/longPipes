...
public class Type1 extends Pipe {
    ...
    public Type1(double length, double d, int plasticGrade, int colorPrint, boolean innerInsulation, boolean outerInsulation, boolean chemRes) {
        this.length = length;
        this.d = d;
